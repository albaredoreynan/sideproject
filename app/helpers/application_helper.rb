module ApplicationHelper
 ...
 #  def sortable(column, title = nil)
  ...
  def calculate_time_by_practice_code_per_lawyer(practice_code, beg_date, end_date, lawyer_id)
  	@case = CaseEntry.where("practice_code =? AND entry_date >= ? AND entry_date <= ? AND lawyer_id =? ", practice_code, beg_date, end_date, lawyer_id)
  	@total_hours = Array.new
  	@hours = Array.new
		@minutes = Array.new
		if !@case.empty?	
